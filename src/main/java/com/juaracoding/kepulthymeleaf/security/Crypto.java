...
public class Crypto {
    ...
    private static final String defaultKey = "b922a203a5d7e1a7c88d8059cefb32ed";
...
//        String strToEncrypt = "debytesting16@gmail.com";//put text to encrypt in here
        String strToEncrypt = "qwerq";//put text to encrypt in here
...
//        String strToDecrypt = "0d3f28a8cb0577e4fd42fbfdf2f72eac";//put text to decrypt in here
        String strToDecrypt = "5068cb178fec68f8d003354943d3709f";//put text to decrypt in here
